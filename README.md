...
<br>
Run run.py file and click on the http link in the terminal. <br> Type node server.js in a split terminal in folder "video-conferencing/webrtc-videocall-javascript" to run the video conferencing at the same time.
